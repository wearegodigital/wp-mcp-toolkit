	...
	private static function missing_autoloader_notice(): void {
		...
		foreach ( $hooks as $hook ) {
			add_action(
				$hook,
				static function () {
					$error_message = __( 'MCP Adapter: The Composer autoloader was not found. If you installed the plugin from the GitHub source code, make sure to run `composer install`.', 'wp-mcp-toolkit' );
